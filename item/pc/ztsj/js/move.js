...
function getByClass(oParent, sClass) {
	...
	var oBtnPrev = getByClass(oDiv, 'shzr_prev')[0];
	var oBtnNext = getByClass(oDiv, 'shzr_next')[0];
	...
	function tab() {
		...
		startMove(aLiBig[now], 'height', 420);
	...
	var timer = setInterval(oBtnNext.onclick, 2000000);
	oDiv.onmouseover = function() {
		clearInterval(timer);
	};
	oDiv.onmouseout = function() {
		timer = setInterval(oBtnNext.onclick, 2000000);
	};
// JavaScript Document
