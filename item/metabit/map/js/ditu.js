 ...
 map.centerAndZoom(point, 17);
        ...
        if(a=='guangdong'){
           var content = '<div style="margin:0;padding:2px;"><div style="width:183px;height:70px;line-height:20px;float: left;padding-top:20px;">地址：广州市<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邦华环球广场<br/>电话： 020-12345678</div><img src="" alt="" style="float:left;zoom:1;overflow:hidden;width:100px;height:100px;margin-left:3px;"/></div>';
            ...
            var content = '<div style="margin:0;padding:2px;"><div style="width:183px;height:70px;line-height:20px;float: left;padding-top:20px;">地址：北京市海淀区温泉镇<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北辰香麓雅庭<br/>电话： 010-12345678</div><img src="" alt="" style="float:left;zoom:1;overflow:hidden;width:100px;height:100px;margin-left:3px;"/></div>';
            };
